...
logger_args="--logger.save_dir runs/cls/mbv2/cifar10/SVD/k1"
...
model_args="--model.truncated_SVD_k 1 --model.with_SVD_compression True --model.set_bn_eval True --model.use_sgd True --model.learning_rate 0.05 --model.num_classes 10 --model.momentum 0 --model.anneling_steps 50 --model.scheduler_interval epoch --trainer.gradient_clip_val 2.0"
...
# python trainer_cls.py ${common_args} --logger.exp_name SVD_l43_k1_${usr_group_kl} --model.num_of_finetune 43
# python trainer_cls.py ${common_args} --logger.exp_name SVD_l44_k1_${usr_group_kl} --model.num_of_finetune 44
# python trainer_cls.py ${common_args} --logger.exp_name SVD_l45_k1_${usr_group_kl} --model.num_of_finetune 45
# python trainer_cls.py ${common_args} --logger.exp_name SVD_l46_k1_${usr_group_kl} --model.num_of_finetune 46
# python trainer_cls.py ${common_args} --logger.exp_name SVD_l47_k1_${usr_group_kl} --model.num_of_finetune 47
# python trainer_cls.py ${common_args} --logger.exp_name SVD_l48_k1_${usr_group_kl} --model.num_of_finetune 48
# python trainer_cls.py ${common_args} --logger.exp_name SVD_l49_k1_${usr_group_kl} --model.num_of_finetune 49
# python trainer_cls.py ${common_args} --logger.exp_name SVD_l50_k1_${usr_group_kl} --model.num_of_finetune 50
# python trainer_cls.py ${common_args} --logger.exp_name SVD_l51_k1_${usr_group_kl} --model.num_of_finetune 51
# python trainer_cls.py ${common_args} --logger.exp_name SVD_l52_k1_${usr_group_kl} --model.num_of_finetune 52