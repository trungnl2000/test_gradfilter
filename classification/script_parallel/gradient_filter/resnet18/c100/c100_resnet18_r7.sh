...
logger_args="--logger.save_dir runs/cls/resnet18/cifar100/gradfilt/r7"
...
model_args="--model.filt_radius 7 --model.with_grad_filter True --model.set_bn_eval True --model.use_sgd True --model.learning_rate 0.05 --model.num_classes 100 --model.momentum 0 --model.anneling_steps 50 --model.scheduler_interval epoch --trainer.gradient_clip_val 2.0"
