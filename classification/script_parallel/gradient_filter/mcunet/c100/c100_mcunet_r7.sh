...
logger_args="--logger.save_dir runs/cls/mcunet/cifar100/gradfilt/r7"
...
model_args="--model.with_grad_filter True --model.filt_radius 7 --model.set_bn_eval True --model.use_sgd True --model.learning_rate 0.05 --model.num_classes 100 --model.momentum 0 --model.anneling_steps 50 --model.scheduler_interval epoch --trainer.gradient_clip_val 2.0"
