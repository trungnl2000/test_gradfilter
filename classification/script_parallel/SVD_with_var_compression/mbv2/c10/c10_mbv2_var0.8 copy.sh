...
logger_args="--logger.save_dir runs/cls/32/mbv2/cifar10/SVD_dim0/var0.8"
data_args="--data.name cifar10 --data.data_dir data/cifar10 --data.train_workers 24 --data.val_workers 24 --data.width 32 --data.height 32"
trainer_args="--trainer.max_epochs 50"
model_args="--model.SVD_var 0.8 --model.with_SVD_with_var_compression True --model.set_bn_eval True --model.use_sgd True --model.learning_rate 0.05 --model.num_classes 10 --model.momentum 0 --model.anneling_steps 50 --model.scheduler_interval epoch --trainer.gradient_clip_val 2.0"
...
python trainer_cls.py ${common_args} --logger.exp_name SVD_l37_var0.8_${usr_group_kl} --model.num_of_finetune 37
python trainer_cls.py ${common_args} --logger.exp_name SVD_l38_var0.8_${usr_group_kl} --model.num_of_finetune 38
python trainer_cls.py ${common_args} --logger.exp_name SVD_l39_var0.8_${usr_group_kl} --model.num_of_finetune 39
python trainer_cls.py ${common_args} --logger.exp_name SVD_l40_var0.8_${usr_group_kl} --model.num_of_finetune 40
python trainer_cls.py ${common_args} --logger.exp_name SVD_l41_var0.8_${usr_group_kl} --model.num_of_finetune 41
python trainer_cls.py ${common_args} --logger.exp_name SVD_l42_var0.8_${usr_group_kl} --model.num_of_finetune 42
python trainer_cls.py ${common_args} --logger.exp_name SVD_l43_var0.8_${usr_group_kl} --model.num_of_finetune 43
python trainer_cls.py ${common_args} --logger.exp_name SVD_l44_var0.8_${usr_group_kl} --model.num_of_finetune 44
python trainer_cls.py ${common_args} --logger.exp_name SVD_l45_var0.8_${usr_group_kl} --model.num_of_finetune 45
python trainer_cls.py ${common_args} --logger.exp_name SVD_l46_var0.8_${usr_group_kl} --model.num_of_finetune 46
python trainer_cls.py ${common_args} --logger.exp_name SVD_l47_var0.8_${usr_group_kl} --model.num_of_finetune 47
python trainer_cls.py ${common_args} --logger.exp_name SVD_l48_var0.8_${usr_group_kl} --model.num_of_finetune 48
python trainer_cls.py ${common_args} --logger.exp_name SVD_l49_var0.8_${usr_group_kl} --model.num_of_finetune 49
python trainer_cls.py ${common_args} --logger.exp_name SVD_l50_var0.8_${usr_group_kl} --model.num_of_finetune 50
python trainer_cls.py ${common_args} --logger.exp_name SVD_l51_var0.8_${usr_group_kl} --model.num_of_finetune 51
python trainer_cls.py ${common_args} --logger.exp_name SVD_l52_var0.8_${usr_group_kl} --model.num_of_finetune 52