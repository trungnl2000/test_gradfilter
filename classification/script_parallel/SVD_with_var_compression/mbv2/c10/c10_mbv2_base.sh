...
logger_args="--logger.save_dir runs/cls/mbv2/cifar10/base"
...
model_args="--model.truncated_SVD_k 1 --model.with_SVD_compression False --model.set_bn_eval True --model.use_sgd True --model.learning_rate 0.05 --model.num_classes 10 --model.momentum 0 --model.anneling_steps 50 --model.scheduler_interval epoch --trainer.gradient_clip_val 2.0"
